package cucumber.steps.mySteps;
...
public class OrderSteps extends SpringIntegrationTest {
            ...
            wiremock.stubFor(get(urlMatching(userBasePath+".*"))
                    .willReturn(
                            aResponse()
                                    ...
                                    .withBodyFile("cucumber/features/mocks/user.json")));
        }
    }
    ...
    public void order_response_equals(String schema){
        response.then().assertThat().body(matchesJsonSchemaInClasspath("cucumber/features/schemas/" +schema+".json"));
    }
